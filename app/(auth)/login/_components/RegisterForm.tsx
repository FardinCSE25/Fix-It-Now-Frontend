        ...
        >
            ...
            <div className="space-y-3">
                ...
                <div className="flex gap-4">
                    ...
                    <label
                        className={`flex cursor-pointer items-center gap-3 rounded-xl border px-4 py-3 transition ${role === "Customer"
                    ...
                    <label
                        className={`flex cursor-pointer items-center gap-3 rounded-xl border px-4 py-3 transition ${role === "Technician"
                            ? "border-primary bg-primary/10"
                            : "border-border"
                            }`}
                    >
